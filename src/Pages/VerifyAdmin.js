        ...
        const fetchData = async () => {
            ...
            try{
                ...
                setTimeout(()=>{
                    ...
                    history.push({pathname: '/ChangeAdminPassword',
    ...
    if (loadingverify) {
        return (
            ...
            <div style={{ padding: "5px 20px", textAlign: "center", justifyContent:"center", display:"flex", alignItems:"center", width:"100%", height:"90vh", backgroundColor:"#f1f1f1"}}>
                ...
                <h2 className="page-header" style={{  textAlign: "center", justifyContent:"center", display:"flex", alignItems:"center"}}><a href="/Loginadmin">Account verified!Please Login</a></h2>
            </div>
        )
    }
    return (
