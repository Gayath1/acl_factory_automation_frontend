    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try{
                ...
                const loginResponse = await axios.post(`https://acl-automation.herokuapp.com/api/v1/Executives/1/verify/${confirmationCode}`,body);
                setloadingverify(true)
                setTimeout(()=>{
                    //this will make sure the loader is not showed anymore, and your main content will popup
                    setloadingverify(false)
                    history.push({pathname: '/ChangeExecutivePassword',
    ...
    if (loadingverify) {
        return (
            <div className="layout__content-main">
                ...
                <h2 className="page-header" style={{  textAlign: "center", justifyContent:"center", display:"flex", alignItems:"center"}}><a href="/Loginexecutive">Account verified!Please Login</a></h2>
            </div>
        )
    }
    return (
