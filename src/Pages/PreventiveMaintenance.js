    ...
    useEffect(() => {
        const fetchData = async () => {
            const result = await axios(
                `https://acl-automation.herokuapp.com/api/v1/PreventiveMaintenanceController/1/getall`, headers
            );
            setListData({lists: result.data.data.preventiveMaintenanceDetails})
            setLoading(false);
        };
        fetchData();
    }, [])
                ...
                <>
                    ...
                    <div id="main" className="layout__content">
                        ...
                        <div className="layout__content-main">
                            <h2 className="page-header">Preventive Maintenance</h2>
                            <div className="row">
                                <div className="col-6">
                                        ...
                                        <div>
                                            <form onSubmit={submit}>
                                                ...
                                                <div className="rowuser">
                                                    ...
                                                    <input type="text" autoFocus placeholder="Production line"
                                                           value={productlineId}
                                                ...
                                                <div className="rowuser">
                                                    ...
                                                    <input type="text" autoFocus placeholder="shift id"
                                                           value={shiftId}
                                                ...
                                                <div className="rowuser">
                                                    ...
                                                    <input type="date" autoFocus placeholder="shift id"
                                                           value={date}
