...
const ForgotPasswordManagement = (props) => {
    ...
    const submit = async (e) => {
        ...
        try{
            ...
            const loginResponse = await axios.post(`https://acl-automation.herokuapp.com/api/v1/Management/1/forgotpasswordverify/Changepassword/${confirmationCode}`,body);
...
export default ForgotPasswordManagement