...
const SendEmailmanagement = () => {
    ...
    const submit = async (e) => {
        ...
        try{
            ...
            const body = {email};
            const loginResponse = await axios.post("https://acl-automation.herokuapp.com/api/v1/Management/1/forgotpasswordverify/email",body);
...
export default SendEmailmanagement
